...
with header_section:
    ...
    st.markdown('Ein Projekt von Martin Stenke & [**Michael Heistruevers**](https://www.linkedin.com/in/michael-heistruevers/) (Systems Engineer, Nutanix Germany GmbH) zur Rückwärtsrechnung für eine einfachere Projektzeitraumplanung.  \n(Zuletzt aktualisiert: 08.10.2024)')
