...
with header_section:
    ...
    st.markdown('Ein Hobby-Projekt von [**Martin Stenke**](https://www.linkedin.com/in/mstenke/) zur Rückwärtsrechnung für eine einfachere Projektzeitraumplanung. (Zuletzt aktualisiert: 26.01.2022)')
